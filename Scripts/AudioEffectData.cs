...
#if ODIN_INSPECTOR_3
		[BoxGroup("Info"), Tooltip("The effect's key, used to access the audio effect in code.")] public AudioKey key = default;
...
#else
        [Tooltip("The effect's key, used to access the audio effect in code.")] public AudioKey key = default;
